...
public class power_spawner : MonoBehaviour
{
    ...
    IEnumerator waitSpawner()
    {
        ...
        while (true)
        {
            ...
            GameObject spawnedpower = Instantiate(objects[object_index], spawnPosition + transform.TransformPoint(0, 0, 0), Quaternion.identity /*gameObject.transform.rotation*/);
